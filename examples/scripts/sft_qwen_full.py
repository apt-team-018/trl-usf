...
"""
Full Fine-Tuning for Qwen2.5 Text Models (0.5B - 32B)

Example usage:

# Single GPU (3B model with 24GB VRAM)
python examples/scripts/sft_qwen_full.py \
    --model_name_or_path Qwen/Qwen2.5-3B-Instruct \
    --dataset_name trl-lib/Capybara \
    --output_dir Qwen2.5-3B-Full-SFT \
...
accelerate launch --config_file examples/accelerate_configs/deepspeed_zero3.yaml \
    ...
    --dataset_name trl-lib/Capybara \
    --output_dir Qwen2.5-7B-Full-SFT \
...
- Qwen2.5-3B: ~12GB VRAM (Single GPU: RTX 3090, A10)
- Qwen2.5-7B: ~28GB VRAM (Multi-GPU recommended or DeepSpeed ZeRO-3)
- Qwen2.5-14B: ~56GB VRAM (Multi-GPU with DeepSpeed/FSDP)
- Qwen2.5-32B: ~128GB VRAM (Multi-GPU with DeepSpeed ZeRO-3)
"""
...
if __name__ == "__main__":
    ...
    trainer.accelerator.print("✅ Full fine-tuning completed.")
